...
public class FinancialSalesBalanceProvider {
    ...
    public String addInfo(Map<String, Object> infoMap) {
        ...
        String prefix = "insert into " + db +
                ...
                "`create_date`,`create_id_user`,`recording_id`)" +
                " values";
        // 保存sql后缀
    ...
    public String getFbsInfo(FinancialSalesBalance fbs) {
        ...
        sql.SELECT("`balance_id`, `years`,`pediod`,`date`, `shop_id`,`site_id`,\n" +
                "`settlement_id`,`payment_type_id`,`type`,`order_id`,`financial_sku`, `sku_id`, `description`,`o_quantity`,\n" +
                ...
                "FROM " + table + " AS " + alias + ","+ProviderSqlStore.joinTable(sql,alias)+" \n");
